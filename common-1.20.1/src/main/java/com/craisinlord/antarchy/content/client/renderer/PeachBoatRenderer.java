...
public class PeachBoatRenderer<T extends Boat> extends EntityRenderer<T> {
    ...
    public static ModelLayerLocation boatLayer() {
        return new ModelLayerLocation(new ResourceLocation("antarchy", "boat/peach"), MAIN_LAYER);
    }

    public static ModelLayerLocation chestBoatLayer() {
        return new ModelLayerLocation(new ResourceLocation("antarchy", "chest_boat/peach"), MAIN_LAYER);
    }
