...
public class OuranwoodBoatOnlyItem extends OuranwoodBoatItem {
    private final java.util.function.Supplier<EntityType<OuranwoodBoatEntity>> entityType;

    public OuranwoodBoatOnlyItem(java.util.function.Supplier<EntityType<OuranwoodBoatEntity>> entityType, Properties properties) {
        super(properties);
    ...
    protected Boat createBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        ...
        OuranwoodBoatEntity boat = new OuranwoodBoatEntity(this.entityType.get(), level);
