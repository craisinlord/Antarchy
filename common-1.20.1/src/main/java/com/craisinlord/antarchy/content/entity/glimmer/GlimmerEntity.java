...
public class GlimmerEntity extends TamableAnimal implements GeoEntity {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(VARIANT, GlimmerVariant.APPLE_COW.ordinal());
        this.entityData.define(SHEAR_COOLDOWN, 0);
        this.entityData.define(FADE_TICKS, 0);
        this.entityData.define(FOLLOWING, true);
        this.entityData.define(ABILITY_COOLDOWN, 0);
        this.entityData.define(GROWTH_SCALE, 1.0F);
        this.entityData.define(ABILITY_ANIM_TICKS, 0);
        this.entityData.define(ELKA_IDLE_SITTING, false);
        this.entityData.define(ELKA_IDLE_QUIRK_TICKS, 0);
        this.entityData.define(ELKA_IDLE_QUIRK_VARIANT, 0);
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnReason, @Nullable SpawnGroupData spawnGroupData, @org.jetbrains.annotations.Nullable net.minecraft.nbt.CompoundTag dataTag) {
        SpawnGroupData result = super.finalizeSpawn(level, difficulty, spawnReason, spawnGroupData, dataTag);
