...
public class AntModel extends GeoModel<BaseAntEntity> {
    private static final ResourceLocation MODEL = new ResourceLocation(Antarchy.MODID, "geo/ant.geo.json");
    private static final ResourceLocation ANIMATIONS = new ResourceLocation(Antarchy.MODID, "animations/ant.animation.json");
    private static final ResourceLocation BROWN_TEXTURE = new ResourceLocation(Antarchy.MODID, "textures/entity/brown_ant.png");
    private static final ResourceLocation RED_TEXTURE = new ResourceLocation(Antarchy.MODID, "textures/entity/red_ant.png");
    private static final ResourceLocation RAINBOW_TEXTURE = new ResourceLocation(Antarchy.MODID, "textures/entity/rainbow_ant.png");
