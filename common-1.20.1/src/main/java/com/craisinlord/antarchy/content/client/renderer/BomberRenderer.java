...
public class BomberRenderer extends GeoEntityRenderer<BomberEntity> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/bomber.png");
    ...
    @Override
    public void preRender(PoseStack poseStack, BomberEntity animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
