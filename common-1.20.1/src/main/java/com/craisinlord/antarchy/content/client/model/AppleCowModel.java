...
public class AppleCowModel extends GeoModel<AppleCowEntity> {
    private static final ResourceLocation MODEL =
            new ResourceLocation(Antarchy.MODID, "geo/apple_cow.geo.json");
    private static final ResourceLocation BABY_MODEL =
            new ResourceLocation(Antarchy.MODID, "geo/baby_apple_cow.geo.json");
    private static final ResourceLocation ANIMATION =
            new ResourceLocation(Antarchy.MODID, "animations/apple_cow.animation.json");
    private static final ResourceLocation BABY_ANIMATION =
            new ResourceLocation(Antarchy.MODID, "animations/baby_apple_cow.animation.json");
    private static final ResourceLocation APPLE_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/apple_cow.png");
    private static final ResourceLocation APPLE_SHEARED_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/apple_cow_sheared.png");
    private static final ResourceLocation BABY_APPLE_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/baby_apple_cow.png");
    private static final ResourceLocation GOLDEN_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/golden_apple_cow.png");
    private static final ResourceLocation GOLDEN_SHEARED_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/golden_apple_cow_sheared.png");
    private static final ResourceLocation BABY_GOLDEN_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/baby_golden_apple_cow.png");
    private static final ResourceLocation ENCHANTED_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/enchanted_golden_apple_cow.png");
    private static final ResourceLocation ENCHANTED_SHEARED_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/apple_cow/enchanted_golden_apple_cow_sheared.png");
