...
public class ReverieModel extends GeoModel<ReverieEntity> {
    private static final ResourceLocation WHITE_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/reverie/reverie_white.png");
    private static final ResourceLocation YELLOW_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/reverie/reverie_yellow.png");
    private static final ResourceLocation BLUE_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/reverie/reverie_blue.png");
    private static final ResourceLocation PURPLE_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/reverie/reverie_purple.png");
    private static final ResourceLocation RED_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/reverie/reverie_red.png");

    @Override
    public ResourceLocation getModelResource(ReverieEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "geo/reverie.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(ReverieEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "animations/reverie.animation.json");
    }
