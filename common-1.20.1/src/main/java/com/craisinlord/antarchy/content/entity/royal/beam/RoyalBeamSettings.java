...
public record RoyalBeamSettings(
    ...
    public RoyalBeamSettings {
        ...
        targetTracking = net.minecraft.util.Mth.clamp(targetTracking, 0.0D, 1.0D);
        ...
        terrainMutationChance = net.minecraft.util.Mth.clamp(terrainMutationChance, 0.0F, 1.0F);
        terrainDropChance = net.minecraft.util.Mth.clamp(terrainDropChance, 0.0F, 1.0F);
