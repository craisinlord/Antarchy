...
public class FlyingSquirrelModel extends GeoModel<FlyingSquirrelEntity> {
    private static final ResourceLocation REGULAR_TEXTURE = new ResourceLocation("antarchy", "textures/entity/flying_squirrel/flying_squirrel.png");
    private static final ResourceLocation BROWN_TEXTURE = new ResourceLocation("antarchy", "textures/entity/flying_squirrel/flying_squirrel_brown.png");
    private static final ResourceLocation ALBINO_TEXTURE = new ResourceLocation("antarchy", "textures/entity/flying_squirrel/flying_squirrel_albino.png");
    ...
    public ResourceLocation getModelResource(FlyingSquirrelEntity animatable) {
        return new ResourceLocation("antarchy", "geo/flying_squirrel.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(FlyingSquirrelEntity animatable) {
        return new ResourceLocation("antarchy", "animations/flying_squirrel.animation.json");
    }
