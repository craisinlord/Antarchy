...
public class RoyalMountModel extends GeoModel<RoyalMountEntity> {
    ...
    public ResourceLocation getModelResource(RoyalMountEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "geo/" + animatable.geoNameForRender() + ".geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(RoyalMountEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "textures/entity/" + animatable.geoNameForRender() + ".png");
    }

    @Override
    public ResourceLocation getAnimationResource(RoyalMountEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "animations/" + animatable.geoNameForRender() + ".animation.json");
    }
}
