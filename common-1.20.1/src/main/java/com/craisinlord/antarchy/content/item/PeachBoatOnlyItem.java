...
public class PeachBoatOnlyItem extends OuranwoodBoatItem {
    private final java.util.function.Supplier<EntityType<PeachBoatEntity>> entityType;

    public PeachBoatOnlyItem(java.util.function.Supplier<EntityType<PeachBoatEntity>> entityType, Properties properties) {
        super(properties);
    ...
    protected Boat createBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        ...
        PeachBoatEntity boat = new PeachBoatEntity(this.entityType.get(), level);
