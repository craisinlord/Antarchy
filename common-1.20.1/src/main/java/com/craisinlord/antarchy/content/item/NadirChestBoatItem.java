...
public class NadirChestBoatItem extends OuranwoodBoatItem {
    private final Supplier<EntityType<NadirChestBoatEntity>> entityType;

    public NadirChestBoatItem(Supplier<EntityType<NadirChestBoatEntity>> entityType, Properties properties) {
        super(properties);
    ...
    protected Boat createBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        ...
        NadirChestBoatEntity boat = new NadirChestBoatEntity(this.entityType.get(), level);
