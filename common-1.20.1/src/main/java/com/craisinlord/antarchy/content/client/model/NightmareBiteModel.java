...
public class NightmareBiteModel extends GeoModel<NightmareBiteEntity> {
    private static final ResourceLocation PHASE_ONE_TEXTURE = new ResourceLocation(Antarchy.MODID, "textures/vfx/nightmare_bite.png");
    private static final ResourceLocation PHASE_TWO_TEXTURE = new ResourceLocation(Antarchy.MODID, "textures/vfx/nightmare_bite_phase_2.png");

    @Override
    public ResourceLocation getModelResource(NightmareBiteEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "geo/nightmare_bite.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(NightmareBiteEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "animations/nightmare_bite.animation.json");
    }
}
