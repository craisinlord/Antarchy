...
public class ElythiaBiomeSource extends BiomeSource {
    ...
    private static final ResourceKey<Biome> CLOUD_SEA = ResourceKey.create(
            Registries.BIOME,
            new ResourceLocation(Antarchy.MODID, "cloud_sea")
    );
