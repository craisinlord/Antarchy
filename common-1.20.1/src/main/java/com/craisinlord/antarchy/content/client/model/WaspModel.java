...
public class WaspModel extends GeoModel<WaspEntity> {
    private static final ResourceLocation DEFAULT_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/wasp.png");
    private static final ResourceLocation PANDA_TEXTURE =
            new ResourceLocation(Antarchy.MODID, "textures/entity/wasp_panda.png");

    @Override
    public ResourceLocation getModelResource(WaspEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "geo/wasp.geo.json");
    }
    ...
    public ResourceLocation getAnimationResource(WaspEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "animations/wasp.animation.json");
    }
}
