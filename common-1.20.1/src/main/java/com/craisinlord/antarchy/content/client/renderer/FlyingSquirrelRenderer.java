...
public class FlyingSquirrelRenderer extends GeoEntityRenderer<FlyingSquirrelEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, FlyingSquirrelEntity animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
    ...
    @Override
    protected void applyRotations(FlyingSquirrelEntity animatable, PoseStack poseStack, float ageInTicks, float rotationYaw, float partialTick) {
        ...
        super.applyRotations(animatable, poseStack, ageInTicks, appliedYaw, partialTick);
