...
public class CaterpillarEntity extends Animal implements GeoEntity {
    ...
    private static final TagKey<Biome> CAN_SPAWN_BIOMES = TagKey.create(
            ...
            new ResourceLocation(Antarchy.MODID, "caterpillar_can_spawn_biomes")
    );
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(LIFE_STAGE, LifeStage.CRAWLING.ordinal());
        this.entityData.define(EAT_ANIMATION_TICKS, 0);
    }
    ...
    private void setLifeStage(LifeStage stage) {
        ...
        if (previous != stage) {
            ...
            if (previous == LifeStage.CHRYSALIS) {
                this.stopTriggeredAnimation("main_controller", "chrysalis");
            }
        }
    }
