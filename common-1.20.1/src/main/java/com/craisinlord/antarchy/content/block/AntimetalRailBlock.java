...
public class AntimetalRailBlock extends AbstractAntimetalRailBlock {
    ...
    @Override
    public void createBlockStateDefinition(StateDefinition.Builder<net.minecraft.world.level.block.Block, net.minecraft.world.level.block.state.BlockState> builder) {
