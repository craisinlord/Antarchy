...
public class JerryModel extends GeoModel<JerryEntity> {
    ...
    public ResourceLocation getModelResource(JerryEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "geo/" + stageName(animatable) + "_jerry.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(JerryEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "textures/entity/jerry/" + stageName(animatable) + "_jerry.png");
    }

    @Override
    public ResourceLocation getAnimationResource(JerryEntity animatable) {
        return new ResourceLocation(Antarchy.MODID, "animations/" + stageName(animatable) + "_jerry.animation.json");
    }
