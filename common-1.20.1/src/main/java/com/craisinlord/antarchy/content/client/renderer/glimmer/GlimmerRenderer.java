...
public class GlimmerRenderer extends GeoEntityRenderer<GlimmerEntity> {
    ...
    private void renderVanillaModel(EntityModel<GlimmerEntity> model, GlimmerEntity entity, float entityYaw, float partialTick,
        ...
        float brightness = brightnessFor(entity, partialTick);
        float fadeAlpha = entity.getFadeAlpha(partialTick);
        ...
        model.renderToBuffer(poseStack, buffer, packedLight, OverlayTexture.NO_OVERLAY, brightness, brightness, brightness, fadeAlpha);
        ...
        model.renderToBuffer(poseStack, emissiveBuffer, 0xF000F0, OverlayTexture.NO_OVERLAY, brightness, brightness, brightness, fadeAlpha);
    ...
    @Override
    public software.bernie.geckolib.core.object.Color getRenderColor(GlimmerEntity animatable, float partialTick, int packedLight) {
        float brightness = brightnessFor(animatable, partialTick);
        return software.bernie.geckolib.core.object.Color.ofRGBA(brightness, brightness, brightness, animatable.getFadeAlpha(partialTick));
    }
    ...
    private static final class GlimmerEmissiveLayer extends GeoRenderLayer<GlimmerEntity> {
        ...
        public void render(PoseStack poseStack, GlimmerEntity animatable, BakedGeoModel bakedModel, @Nullable RenderType renderType,
            ...
            this.getRenderer().reRender(
                    ...
                    brightnessFor(animatable, partialTick),
                    brightnessFor(animatable, partialTick),
                    brightnessFor(animatable, partialTick),
                    animatable.getFadeAlpha(partialTick)
            );
        }
    }
}
