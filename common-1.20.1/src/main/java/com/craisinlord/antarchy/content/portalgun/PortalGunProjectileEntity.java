...
public class PortalGunProjectileEntity extends ThrowableItemProjectile {
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(SIDE, PortalGunPortalEntity.PortalSide.BLUE.ordinal());
        this.entityData.define(SHOOTER_ID, -1);
        this.entityData.define(DISTANCE, 0);
        this.entityData.define(SPAWN_X, 0);
        this.entityData.define(SPAWN_Y, 0);
        this.entityData.define(SPAWN_Z, 0);
        this.entityData.define(VELOCITY_X, 0.0F);
        this.entityData.define(VELOCITY_Y, 0.0F);
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        if (this.gunId != null && !itemStack.isEmpty()) {
            itemStack.getOrCreateTag().putUUID(PortalGunItem.GUN_ID_TAG, this.gunId);
        }
    }
}
