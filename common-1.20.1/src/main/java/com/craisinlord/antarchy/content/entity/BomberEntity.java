...
public class BomberEntity extends Monster implements GeoEntity {
    private static final ResourceLocation INTENTIONALLY_EMPTY_SOUND_ID = new ResourceLocation("intentionally_empty");
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(FUSE_TICKS_DATA, 0);
        this.entityData.define(DETONATING_DATA, false);
    }
    ...
    public SpawnGroupData finalizeSpawn(ServerLevelAccessor level, DifficultyInstance difficulty, MobSpawnType spawnReason, @Nullable SpawnGroupData spawnGroupData, @org.jetbrains.annotations.Nullable net.minecraft.nbt.CompoundTag dataTag) {
        ...
        SpawnGroupData spawnData = super.finalizeSpawn(level, difficulty, spawnReason, spawnGroupData, dataTag);
        this.primeFuse();
        return spawnData;
    }
    ...
    private void detonate() {
        ...
        serverLevel.playSound(null, x, y, z, SoundEvents.GENERIC_EXPLODE, SoundSource.HOSTILE, 0.55F, 1.0F);
        serverLevel.explode(
                this,
                null,
                null,
