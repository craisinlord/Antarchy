...
public class OuranwoodChestBoatItem extends OuranwoodBoatItem {
    private final java.util.function.Supplier<EntityType<OuranwoodChestBoatEntity>> entityType;

    public OuranwoodChestBoatItem(java.util.function.Supplier<EntityType<OuranwoodChestBoatEntity>> entityType, Properties properties) {
        super(properties);
    ...
    protected Boat createBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        ...
        OuranwoodChestBoatEntity boat = new OuranwoodChestBoatEntity(this.entityType.get(), level);
