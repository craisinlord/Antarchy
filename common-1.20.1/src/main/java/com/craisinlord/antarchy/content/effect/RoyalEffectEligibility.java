...
public final class RoyalEffectEligibility {
    ...
    public static boolean isCommanded(MobEffectInstance instance) {
        return RoyalEffectHooks.commandedHolder() != null && instance.getEffect() == RoyalEffectHooks.commandedHolder();
    }

    public static boolean isDilated(MobEffectInstance instance) {
        return RoyalEffectHooks.dilatedHolder() != null && instance.getEffect() == RoyalEffectHooks.dilatedHolder();
    }
