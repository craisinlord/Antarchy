...
public class WormEntity extends Monster implements GeoEntity {
    private static final ResourceKey<Biome> WORMY_CAVES = ResourceKey.create(
            Registries.BIOME,
            new ResourceLocation(Antarchy.MODID, "wormy_caves")
    );
    private static final ResourceLocation LOAM_ID = new ResourceLocation(Antarchy.MODID, "loam");
    private static final ResourceLocation MUCUS_ID = new ResourceLocation(Antarchy.MODID, "mucus");
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(ANIMATION_STATE, ANIM_INGROUND);
    }
