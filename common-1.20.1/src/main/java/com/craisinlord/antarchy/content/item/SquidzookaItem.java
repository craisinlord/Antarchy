...
public class SquidzookaItem extends ProjectileWeaponItem implements GeoItem, com.craisinlord.antarchy.content.client.AntarchyGeoItem {
    ...
    private static final ResourceLocation MODEL_LOCATION = new ResourceLocation("antarchy", "geo/squidzooka.geo.json");
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("antarchy", "textures/models/item/squidzooka.png");
    private static final ResourceLocation ANIMATION_LOCATION = new ResourceLocation("antarchy", "animations/squidzooka.animation.json");
