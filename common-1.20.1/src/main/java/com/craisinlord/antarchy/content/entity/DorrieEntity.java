...
public class DorrieEntity extends Animal implements GeoEntity {
    private static final ResourceLocation CHEEP_ITEM_ID = new ResourceLocation("antarchy", "cheep");
    ...
    protected void defineSynchedData() {
        ...
        this.entityData.define(JUMP_CHARGE, 0);
    ...
    public void addAdditionalSaveData(CompoundTag tag) {
        ...
        for (int slot = 0; slot < this.inventory.getContainerSize(); slot++) {
            ...
            stackTag.put("Item", stack.save(new CompoundTag()));
    ...
    public void readAdditionalSaveData(CompoundTag tag) {
        ...
        for (int i = 0; i < inventoryTag.size(); i++) {
            ...
            this.inventory.setItem(slot, ItemStack.of(stackTag.getCompound("Item")));
        }
