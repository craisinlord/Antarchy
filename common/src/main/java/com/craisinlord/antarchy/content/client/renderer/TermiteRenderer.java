...
public class TermiteRenderer extends GeoEntityRenderer<TermiteEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, TermiteEntity animatable, BakedGeoModel model, @Nullable MultiBufferSource bufferSource, @Nullable VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
