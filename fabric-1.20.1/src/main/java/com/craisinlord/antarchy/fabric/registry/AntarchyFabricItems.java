...
public final class AntarchyFabricItems {
    ...
    public static final DeferredItem<Item> OURANWOOD_BOAT = ITEMS.register("ouranwood_boat",
            () -> new OuranwoodBoatOnlyItem(AntarchyFabricEntities.OURANWOOD_BOAT_ENTITY, new Item.Properties().stacksTo(1)));


    public static final DeferredItem<Item> OURANWOOD_CHEST_BOAT = ITEMS.register("ouranwood_chest_boat",
            () -> new OuranwoodChestBoatItem(AntarchyFabricEntities.OURANWOOD_CHEST_BOAT_ENTITY, new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredItem<Item> PEACH_BOAT = ITEMS.register("peach_boat",
            () -> new com.craisinlord.antarchy.content.item.PeachBoatOnlyItem(AntarchyFabricEntities.PEACH_BOAT_ENTITY, new Item.Properties().stacksTo(1)));
    ...
    public static final DeferredItem<net.minecraft.world.item.BlockItem> TRIFFID_GOO_BLOCK_ITEM = ITEMS.register("flytrap_goo_block",
    ...
    public static final DeferredItem<Item> UNDERTRIAL_KEY = ITEMS.registerSimpleItem("undertrial_key", new Item.Properties());
    ...
    public static final DeferredItem<BloodCrystalArmorItem> BLOOD_CRYSTAL_HELMET = ITEMS.register("blood_crystal_helmet",
            () -> new BloodCrystalArmorItem(AntarchyFabricMisc.BLOOD_CRYSTAL_ARMOR_MATERIAL, ArmorItem.Type.HELMET, new Item.Properties().rarity(Rarity.RARE)));


    public static final DeferredItem<BloodCrystalArmorItem> BLOOD_CRYSTAL_CHESTPLATE = ITEMS.register("blood_crystal_chestplate",
            () -> new BloodCrystalArmorItem(AntarchyFabricMisc.BLOOD_CRYSTAL_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE, new Item.Properties().rarity(Rarity.RARE)));


    public static final DeferredItem<BloodCrystalArmorItem> BLOOD_CRYSTAL_LEGGINGS = ITEMS.register("blood_crystal_leggings",
            () -> new BloodCrystalArmorItem(AntarchyFabricMisc.BLOOD_CRYSTAL_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS, new Item.Properties().rarity(Rarity.RARE)));
    ...
    public static final DeferredItem<Item> JUMPY_BUG_LEG = ITEMS.registerSimpleItem("springbug_leg", new Item.Properties().rarity(Rarity.UNCOMMON));


    public static final DeferredItem<com.craisinlord.antarchy.content.item.JumpyBootsItem> JUMPY_BOOTS = ITEMS.register("springy_boots",
            () -> new com.craisinlord.antarchy.content.item.JumpyBootsItem(
                    AntarchyFabricMisc.JUMPY_BOOTS_ARMOR_MATERIAL,
                    new Item.Properties().stacksTo(1).rarity(Rarity.UNCOMMON).fireResistant().durability(AntarchyFabricMisc.JUMPY_BOOTS_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.BOOTS))
            ));
    ...
    public static final DeferredItem<Item> TRIFFID_GOO = ITEMS.registerSimpleItem("flytrap_goo",
            new Item.Properties().rarity(Rarity.UNCOMMON));
    ...
    public static final DeferredItem<Item> CLOUD_SHARK_FIN = ITEMS.registerSimpleItem("stratoshark_fin", new Item.Properties().rarity(Rarity.UNCOMMON));


    public static final DeferredItem<CloudSharkFinSoupItem> CLOUD_SHARK_FIN_SOUP = ITEMS.register("stratoshark_fin_soup",
    ...
    public static final DeferredItem<MogglesItem> MOGGLES = ITEMS.register("moggles",
            () -> new MogglesItem(AntarchyFabricMisc.MOGGLES_ARMOR_MATERIAL, new Item.Properties().rarity(Rarity.RARE).stacksTo(1)));
    ...
    public static final DeferredItem<com.craisinlord.antarchy.content.item.FallenKingCrownItem> FALLEN_KING_CROWN = ITEMS.register("fallen_king_crown",
            () -> new com.craisinlord.antarchy.content.item.FallenKingCrownItem(
                    AntarchyFabricMisc.FALLEN_KING_CROWN_ARMOR_MATERIAL,
    ...
    public static final DeferredItem<ArmorItem> ULTIMATE_HELMET = ITEMS.register("ultimate_helmet",
            () -> new UltimateArmorItem(
                    AntarchyFabricMisc.ULTIMATE_ARMOR_MATERIAL,
                    ArmorItem.Type.HELMET,
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.ULTIMATE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.HELMET))
            ));
    ...
    public static final DeferredItem<ArmorItem> ULTIMATE_CHESTPLATE = ITEMS.register("ultimate_chestplate",
            () -> new UltimateArmorItem(
                    ...
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.ULTIMATE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.CHESTPLATE))
            ));
    ...
    public static final DeferredItem<ArmorItem> ULTIMATE_LEGGINGS = ITEMS.register("ultimate_leggings",
            () -> new UltimateArmorItem(
                    ...
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.ULTIMATE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.LEGGINGS))
            ));
    ...
    public static final DeferredItem<ArmorItem> ULTIMATE_BOOTS = ITEMS.register("ultimate_boots",
            () -> new UltimateArmorItem(
                    ...
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.ULTIMATE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.BOOTS))
            ));
    ...
    public static final DeferredItem<NightmareArmorItem> NIGHTMARE_HELMET = ITEMS.register("nightmare_helmet",
            () -> new NightmareArmorItem(
                    AntarchyFabricMisc.NIGHTMARE_ARMOR_MATERIAL,
                    ArmorItem.Type.HELMET,
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.NIGHTMARE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.HELMET))
            ));
    ...
    public static final DeferredItem<NightmareArmorItem> NIGHTMARE_CHESTPLATE = ITEMS.register("nightmare_chestplate",
            () -> new NightmareArmorItem(
                    ...
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.NIGHTMARE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.CHESTPLATE))
            ));
    ...
    public static final DeferredItem<NightmareArmorItem> NIGHTMARE_LEGGINGS = ITEMS.register("nightmare_leggings",
            () -> new NightmareArmorItem(
                    ...
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.NIGHTMARE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.LEGGINGS))
            ));
    ...
    public static final DeferredItem<NightmareArmorItem> NIGHTMARE_BOOTS = ITEMS.register("nightmare_boots",
            () -> new NightmareArmorItem(
                    ...
                    new Item.Properties()
                            .rarity(Rarity.EPIC)
                            .fireResistant()
                            .durability(AntarchyFabricMisc.NIGHTMARE_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.BOOTS))
            ));
    ...
    public static final DeferredItem<DeferredSpawnEggItem> TRIFFID_SPAWN_EGG = ITEMS.register("flytrap_spawn_egg",
    ...
    public static final DeferredItem<DeferredSpawnEggItem> JUMPY_BUG_SPAWN_EGG = ITEMS.register("springbug_spawn_egg",
    ...
    public static final DeferredItem<DeferredSpawnEggItem> CLOUD_SHARK_SPAWN_EGG = ITEMS.register("stratoshark_spawn_egg",
    ...
    public static final DeferredItem<PrimordialArmorItem> PRIMORDIAL_HELMET = ITEMS.register("primordial_helmet",
            () -> new PrimordialArmorItem(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL, ArmorItem.Type.HELMET,
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).fireResistant().durability(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.HELMET))));


    public static final DeferredItem<PrimordialArmorItem> PRIMORDIAL_CHESTPLATE = ITEMS.register("primordial_chestplate",
            () -> new PrimordialArmorItem(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL, ArmorItem.Type.CHESTPLATE,
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).fireResistant().durability(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.CHESTPLATE))));


    public static final DeferredItem<PrimordialArmorItem> PRIMORDIAL_LEGGINGS = ITEMS.register("primordial_leggings",
            () -> new PrimordialArmorItem(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL, ArmorItem.Type.LEGGINGS,
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).fireResistant().durability(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.LEGGINGS))));


    public static final DeferredItem<PrimordialArmorItem> PRIMORDIAL_BOOTS = ITEMS.register("primordial_boots",
            () -> new PrimordialArmorItem(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL, ArmorItem.Type.BOOTS,
                    new Item.Properties().stacksTo(1).rarity(Rarity.RARE).fireResistant().durability(AntarchyFabricMisc.PRIMORDIAL_ARMOR_MATERIAL.getDurabilityForType(ArmorItem.Type.BOOTS))));


    public static final DeferredItem<DeferredSpawnEggItem> CREEPING_HORROR_SPAWN_EGG = ITEMS.register("crawling_blight_spawn_egg",
            () -> new DeferredSpawnEggItem(AntarchyFabricEntities.CREEPING_HORROR, 0x6B3A1F, 0x6B0000, new Item.Properties()));


    public static final DeferredItem<DeferredSpawnEggItem> LURKING_TERROR_SPAWN_EGG = ITEMS.register("skulking_fright_spawn_egg",
