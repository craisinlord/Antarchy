...
public final class AntarchyFabricSounds {
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> STRATOSHARK_BITE = registerSoundEvent("stratoshark_bite");


    public static final DeferredHolder<SoundEvent, SoundEvent> STRATOSHARK_IDLE = registerSoundEvent("stratoshark_idle");


    public static final DeferredHolder<SoundEvent, SoundEvent> STRATOSHARK_HURT = registerSoundEvent("stratoshark_hurt");


    public static final DeferredHolder<SoundEvent, SoundEvent> STRATOSHARK_DEATH = registerSoundEvent("stratoshark_death");


    public static final DeferredHolder<SoundEvent, SoundEvent> STRATOSHARK_FLY = registerSoundEvent("stratoshark_fly");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> FLYTRAP_ATTACK = registerSoundEvent("flytrap_attack");


    public static final DeferredHolder<SoundEvent, SoundEvent> FLYTRAP_GRAB = registerSoundEvent("flytrap_grab");


    public static final DeferredHolder<SoundEvent, SoundEvent> FLYTRAP_HURT = registerSoundEvent("flytrap_hurt");


    public static final DeferredHolder<SoundEvent, SoundEvent> FLYTRAP_DEATH = registerSoundEvent("flytrap_death");


    public static final DeferredHolder<SoundEvent, SoundEvent> FLYTRAP_HISS = registerSoundEvent("flytrap_hiss");


    public static final DeferredHolder<SoundEvent, SoundEvent> FLYTRAP_GROWL = registerSoundEvent("flytrap_growl");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> CRAWLING_BLIGHT_GROWL = registerSoundEvent("crawling_blight_growl");


    public static final DeferredHolder<SoundEvent, SoundEvent> CRAWLING_BLIGHT_HURT = registerSoundEvent("crawling_blight_hurt");


    public static final DeferredHolder<SoundEvent, SoundEvent> CRAWLING_BLIGHT_BITE = registerSoundEvent("crawling_blight_bite");


    public static final DeferredHolder<SoundEvent, SoundEvent> SKULKING_FRIGHT_SNARL = registerSoundEvent("skulking_fright_snarl");


    public static final DeferredHolder<SoundEvent, SoundEvent> SKULKING_FRIGHT_HURT = registerSoundEvent("skulking_fright_hurt");


    public static final DeferredHolder<SoundEvent, SoundEvent> SKULKING_FRIGHT_BITE = registerSoundEvent("skulking_fright_bite");


    public static final DeferredHolder<SoundEvent, SoundEvent> SKULKING_FRIGHT_FLY_LOOP = registerSoundEvent("skulking_fright_fly_loop");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> SPRINGBUG_IDLE = registerSoundEvent("springbug_idle");
    public static final DeferredHolder<SoundEvent, SoundEvent> SPIT_BUG_IDLE = registerSoundEvent("spit_bug_idle");
    public static final DeferredHolder<SoundEvent, SoundEvent> SPRINGBUG_HURT = registerSoundEvent("springbug_hurt");
    public static final DeferredHolder<SoundEvent, SoundEvent> SPRINGBUG_JUMP = registerSoundEvent("springbug_jump");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> MUSIC_DISC_VERDANCE = registerSoundEvent("music_disc_verdance");
    ...
    public static final DeferredHolder<SoundEvent, SoundEvent> KING_ICE_SPIKES = registerSoundEvent("king_ice_spikes");
