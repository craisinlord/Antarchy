...
public final class HerculesBeetleChargeHudRenderer {
    private static final ResourceLocation CHARGE_BAR_BACKGROUND =
            ResourceLocation.withDefaultNamespace("textures/gui/sprites/hud/jump_bar_background.png");
    private static final ResourceLocation CHARGE_BAR_PROGRESS =
            ResourceLocation.withDefaultNamespace("textures/gui/sprites/hud/jump_bar_progress.png");
    ...
    public static void render(GuiGraphics guiGraphics) {
        ...
        guiGraphics.blit(CHARGE_BAR_BACKGROUND, x0, y0, 0, 0, BAR_WIDTH, BAR_HEIGHT, BAR_WIDTH, BAR_HEIGHT);
        if (filledWidth > 0) {
            guiGraphics.setColor(1.0F, 0.78F, 0.2F, 0.45F + chargeRatio * 0.55F);
            guiGraphics.blit(CHARGE_BAR_PROGRESS, x0, y0, 0, 0, filledWidth, BAR_HEIGHT, BAR_WIDTH, BAR_HEIGHT);
