...
public class PeachBoatRenderer<T extends Boat> extends EntityRenderer<T> {
    private static final String MAIN_LAYER = "main";
    private final ResourceLocation texture;
    private final ListModel<Boat> model;

    public PeachBoatRenderer(EntityRendererProvider.Context context, ResourceLocation texture, boolean chest) {
        super(context);
    ...
    public static ModelLayerLocation boatLayer() {
        return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("antarchy", "boat/peach"), MAIN_LAYER);
    }

    public static ModelLayerLocation chestBoatLayer() {
        return new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("antarchy", "chest_boat/peach"), MAIN_LAYER);
    }
