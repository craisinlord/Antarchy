package com.craisinlord.antarchy.content.entity.stratoshark;
...
public class StratosharkEntity extends Monster implements GeoEntity {
    ...
    private static final net.minecraft.network.syncher.EntityDataAccessor<Integer> ANIMATION_STATE =
            net.minecraft.network.syncher.SynchedEntityData.defineId(
                    StratosharkEntity.class, net.minecraft.network.syncher.EntityDataSerializers.INT);
    ...
    public StratosharkEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Mob.createMobAttributes()
                .add(Attributes.MAX_HEALTH, AntarchySettings.stratosharkHealth())
                .add(Attributes.ATTACK_DAMAGE, AntarchySettings.stratosharkAttackDamage())
                .add(Attributes.MOVEMENT_SPEED, AntarchySettings.stratosharkMovementSpeed())
                .add(Attributes.FLYING_SPEED, AntarchySettings.stratosharkFlyingSpeed())
                .add(Attributes.FOLLOW_RANGE, 40.0D)
                .add(Attributes.KNOCKBACK_RESISTANCE, AntarchySettings.stratosharkKnockbackResistance());
    }
    ...
    public net.minecraft.world.entity.SpawnGroupData finalizeSpawn(net.minecraft.world.level.ServerLevelAccessor level, net.minecraft.world.DifficultyInstance difficulty, net.minecraft.world.entity.MobSpawnType spawnReason, net.minecraft.world.entity.SpawnGroupData spawnData) {
        com.craisinlord.antarchy.content.entity.ConfiguredMobSpawnUtil.applyConfiguredHealth(this, AntarchySettings.stratosharkHealth());
    ...
    public static boolean canSpawn(EntityType<StratosharkEntity> entityType, ServerLevelAccessor level,
    ...
    protected void registerGoals() {
        ...
        hurtByTargetGoal.setAlertOthers(StratosharkEntity.class);
        this.targetSelector.addGoal(1, hurtByTargetGoal);
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, Player.class, 10, true, false, StratosharkEntity::isTargetablePlayer));
    }
    ...
    public boolean doHurtTarget(Entity target) {
        ...
        if (hurt && target instanceof LivingEntity livingTarget) {
            ...
            this.playSound(AntarchySoundEvents.STRATOSHARK_BITE.get(), 1.0F, 0.85F + this.random.nextFloat() * 0.2F);
        }
        return hurt;
    }
    ...
    @Override
    protected SoundEvent getHurtSound(DamageSource damageSource) { return AntarchySoundEvents.STRATOSHARK_HURT.get(); }

    @Override
    protected SoundEvent getDeathSound() { return AntarchySoundEvents.STRATOSHARK_DEATH.get(); }
    ...
    private void tickFlySound() {
        ...
        this.playSound(AntarchySoundEvents.STRATOSHARK_FLY.get(), 0.7F, 1.0F);
    ...
    private PlayState mainAnimController(AnimationState<StratosharkEntity> state) {
    ...
    private static final class SharknadoOrbitGoal extends Goal {
        ...
        private final StratosharkEntity shark;

        SharknadoOrbitGoal(StratosharkEntity shark) {
            this.shark = shark;
