...
public class InfestedCoarseDirtBlock extends Block {
    private final MapCodec<InfestedCoarseDirtBlock> codec;

    public InfestedCoarseDirtBlock(BlockBehaviour.Properties properties) {
        super(properties);
        this.codec = Block.simpleCodec(ignored -> this);
    }

    @Override
    public MapCodec<InfestedCoarseDirtBlock> codec() {
        return this.codec;
    }
