...
public class PeachChestBoatItem extends OuranwoodBoatItem {
    private final EntityType<PeachChestBoatEntity> entityType;

    public PeachChestBoatItem(EntityType<PeachChestBoatEntity> entityType, Properties properties) {
        super(properties);
    ...
    protected Boat createBoat(Level level, HitResult hitResult, ItemStack stack, Player player) {
        ...
        PeachChestBoatEntity boat = new PeachChestBoatEntity(this.entityType, level);
