...
public final class AntarchyToolsConfig {
    ...
    private static final ForgeConfigSpec.DoubleValue BASILISK_DAGGER_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue BASILISK_DAGGER_ATTACK_SPEED;
    private static final ForgeConfigSpec.IntValue    BASILISK_DAGGER_POISON_DURATION_TICKS;
    private static final ForgeConfigSpec.IntValue    BASILISK_DAGGER_POISON_AMPLIFIER;


    // Ultimate Tools

    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_SWORD_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_SWORD_ATTACK_SPEED;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_PICKAXE_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_PICKAXE_ATTACK_SPEED;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_AXE_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_AXE_ATTACK_SPEED;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_SHOVEL_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_SHOVEL_ATTACK_SPEED;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_HOE_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_HOE_ATTACK_SPEED;
    private static final ForgeConfigSpec.IntValue     ULTIMATE_TOOL_ENCHANTABILITY;
    private static final ForgeConfigSpec.BooleanValue ULTIMATE_TOOLS_THREE_BY_THREE_ENABLED;


    // Ultimate Bow

    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_BOW_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_BOW_PLAYER_HEAL;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_BOW_DRAW_SPEED_MULTIPLIER;
    private static final ForgeConfigSpec.BooleanValue ULTIMATE_BOW_COMES_ENCHANTED_WITH_FLAME;
    private static final ForgeConfigSpec.IntValue     ULTIMATE_BOW_ENCHANTABILITY;


    // Ultimate Crossbow

    private static final ForgeConfigSpec.DoubleValue ULTIMATE_CROSSBOW_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue ULTIMATE_CROSSBOW_CHARGE_SPEED_MULTIPLIER;
    ...
    private static final ForgeConfigSpec.IntValue     ULTIMATE_ARMOR_ENCHANTABILITY;
    private static final ForgeConfigSpec.IntValue     ULTIMATE_HELMET_ARMOR_VALUE;
    private static final ForgeConfigSpec.IntValue     ULTIMATE_CHESTPLATE_ARMOR_VALUE;
    private static final ForgeConfigSpec.IntValue     ULTIMATE_LEGGINGS_ARMOR_VALUE;
    private static final ForgeConfigSpec.IntValue     ULTIMATE_BOOTS_ARMOR_VALUE;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_HELMET_ARMOR_TOUGHNESS;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_CHESTPLATE_ARMOR_TOUGHNESS;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_LEGGINGS_ARMOR_TOUGHNESS;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_BOOTS_ARMOR_TOUGHNESS;
    private static final ForgeConfigSpec.DoubleValue  ULTIMATE_ARMOR_KNOCKBACK_RESISTANCE;


    // Battle Axe

    private static final ForgeConfigSpec.DoubleValue BATTLE_AXE_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue BATTLE_AXE_ATTACK_SPEED;


    // Big Bertha

    private static final ForgeConfigSpec.DoubleValue BIG_BERTHA_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue BIG_BERTHA_REACH_BONUS;
    private static final ForgeConfigSpec.DoubleValue BIG_BERTHA_ATTACK_SPEED;
    private static final ForgeConfigSpec.DoubleValue ATTITUDE_ADJUSTER_BASE_DAMAGE;
    private static final ForgeConfigSpec.BooleanValue ATTITUDE_ADJUSTER_BREAKS_BLOCKS;
    private static final ForgeConfigSpec.DoubleValue KRAKENS_GRASP_ATTACK_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue KRAKENS_GRASP_ATTACK_SPEED;
    private static final ForgeConfigSpec.DoubleValue KRAKENS_GRASP_THROWN_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue KRAKENS_GRASP_LIGHTNING_DAMAGE;
    private static final ForgeConfigSpec.BooleanValue KRAKENS_GRASP_INNATE_LOYALTY;
    private static final ForgeConfigSpec.IntValue KRAKENS_GRASP_INNATE_LOYALTY_LEVEL;
    private static final ForgeConfigSpec.IntValue KRAKENS_GRASP_TENTACLE_DURATION_TICKS;
    private static final ForgeConfigSpec.DoubleValue KRAKENS_GRASP_TENTACLE_RADIUS;
    private static final ForgeConfigSpec.IntValue KRAKENS_GRASP_TENTACLE_SLOWNESS_AMPLIFIER;
    private static final ForgeConfigSpec.IntValue KRAKENS_GRASP_TENTACLE_SLOWNESS_REFRESH_TICKS;
    private static final ForgeConfigSpec.IntValue    BIG_BERTHA_BASILISK_PARALYZE_DURATION_TICKS;
    private static final ForgeConfigSpec.IntValue    BIG_BERTHA_KRAKEN_SLOW_TICKS;
    private static final ForgeConfigSpec.DoubleValue BIG_BERTHA_BASILISK_COOLDOWN_SECONDS;
    private static final ForgeConfigSpec.DoubleValue BIG_BERTHA_LUCID_INVERTED_DURATION_SECONDS;
    private static final ForgeConfigSpec.DoubleValue BIG_BERTHA_LUCID_INVERTED_DAMAGE_BONUS_PERCENT;
    ...
    private static final ForgeConfigSpec.IntValue    NIGHTMARE_HELMET_ARMOR_VALUE;
    private static final ForgeConfigSpec.IntValue    NIGHTMARE_CHESTPLATE_ARMOR_VALUE;
    private static final ForgeConfigSpec.IntValue    NIGHTMARE_LEGGINGS_ARMOR_VALUE;
    private static final ForgeConfigSpec.IntValue    NIGHTMARE_BOOTS_ARMOR_VALUE;
    private static final ForgeConfigSpec.DoubleValue NIGHTMARE_HELMET_ARMOR_TOUGHNESS;
    private static final ForgeConfigSpec.DoubleValue NIGHTMARE_CHESTPLATE_ARMOR_TOUGHNESS;
    ...
    private static final ForgeConfigSpec.IntValue    FALLEN_KING_CROWN_ARMOR_VALUE;
    private static final ForgeConfigSpec.DoubleValue FALLEN_KING_CROWN_ARMOR_TOUGHNESS;


    // Blood Crystal Armor

    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_ARMOR_SHIELD_RECHARGE_TICKS;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_APPLE_SHIELD_COUNT;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_APPLE_DURATION_TICKS;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_APPLE_SHIELD_RECHARGE_TICKS;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_HARD_MAX_SHIELDS;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_HELMET_DEFENSE;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_CHESTPLATE_DEFENSE;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_LEGGINGS_DEFENSE;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_BOOTS_DEFENSE;
    private static final ForgeConfigSpec.DoubleValue BLOOD_CRYSTAL_ARMOR_TOUGHNESS;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_HELMET_DURABILITY;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_CHESTPLATE_DURABILITY;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_LEGGINGS_DURABILITY;
    private static final ForgeConfigSpec.IntValue    BLOOD_CRYSTAL_BOOTS_DURABILITY;


    // Squidzooka

    private static final ForgeConfigSpec.DoubleValue SQUIDZOOKA_COOLDOWN_SECONDS;
    private static final ForgeConfigSpec.DoubleValue SQUIDZOOKA_LAUNCH_VELOCITY;
    private static final ForgeConfigSpec.DoubleValue RPO_LAUNCHER_COOLDOWN_SECONDS;
    private static final ForgeConfigSpec.DoubleValue RPO_LAUNCHER_LAUNCH_VELOCITY;
    private static final ForgeConfigSpec.DoubleValue RPO_LAUNCHER_EXPLOSION_DAMAGE;
    private static final ForgeConfigSpec.DoubleValue RPO_LAUNCHER_EXPLOSION_RADIUS;


    // Size Rays

    private static final ForgeConfigSpec.BooleanValue SIZE_CHANGING_RAYS_ENABLED;
    private static final ForgeConfigSpec.DoubleValue  SIZE_RAY_COOLDOWN_SECONDS;
    private static final ForgeConfigSpec.DoubleValue  SIZE_RAY_MIN_SCALE;
    private static final ForgeConfigSpec.DoubleValue  SIZE_RAY_MAX_SCALE;
    private static final ForgeConfigSpec.DoubleValue  SIZE_RAY_DELTA_PER_HIT;
    private static final ForgeConfigSpec.DoubleValue  SHRINKING_POTION_DELTA;
    private static final ForgeConfigSpec.DoubleValue  GROWTH_POTION_DELTA;


    // Gravity Gun

    private static final ForgeConfigSpec.BooleanValue GRAVITY_GUN_ENABLED;
    private static final ForgeConfigSpec.BooleanValue GRAVITY_GUN_BLOCKS_ENABLED;
    private static final ForgeConfigSpec.BooleanValue GRAVITY_GUN_ENTITIES_ENABLED;
    private static final ForgeConfigSpec.DoubleValue  GRAVITY_GUN_RANGE;
    private static final ForgeConfigSpec.DoubleValue  GRAVITY_GUN_THROW_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue  GRAVITY_GUN_BLAST_STRENGTH;
    private static final ForgeConfigSpec.DoubleValue  GRAVITY_GUN_COOLDOWN_SECONDS;
    private static final ForgeConfigSpec.DoubleValue  GRAVITY_GUN_MAX_HOLD_DISTANCE;

    // Critter Cage

    private static final ForgeConfigSpec.DoubleValue  CRITTER_CAGE_MAX_CAPTURABLE_WIDTH;
    private static final ForgeConfigSpec.DoubleValue  CRITTER_CAGE_MAX_CAPTURABLE_HEIGHT;
    ...
    private static final ForgeConfigSpec.DoubleValue  DUCT_TAPE_REPAIR_PERCENT_PER_USE;
    private static final ForgeConfigSpec.DoubleValue  POTENT_NYXITE_INVERTED_DURATION_SECONDS;
    private static final ForgeConfigSpec.BooleanValue INVERT_PROJECTILES_FROM_INVERTED_PLAYERS;
    private static final ForgeConfigSpec.IntValue     CORNEA_EAR_NIGHT_VISION_SECONDS;
    private static final ForgeConfigSpec.BooleanValue AMERICAN_ENABLED;
    private static final ForgeConfigSpec.IntValue     AMERICAN_BONUS_NUTRITION;
    private static final ForgeConfigSpec.DoubleValue  AMERICAN_BONUS_SATURATION;
    private static final ForgeConfigSpec.IntValue     AMERICAN_REGENERATION_DURATION_TICKS;
    private static final ForgeConfigSpec.IntValue     AMERICAN_REGENERATION_AMPLIFIER;
    ...
    static {
        ...
        NIGHTMARE_SWORD_BASE_DAMAGE     = b
                ...
                .defineInRange("baseDamage",    15.0D, 0.0D, 1024.0D);
        ...
        NIGHTMARE_SWORD_SCALING_FACTOR  = b
                ...
                .defineInRange("scalingFactor",  1.5D, 0.0D, 100.0D);
        b.pop();
