...
public final class AntarchyMiscConfig {
    ...
    private static final ForgeConfigSpec.DoubleValue  DREAM_SAND_FALL_DAMAGE_MULTIPLIER;
    ...
    private static final ForgeConfigSpec.BooleanValue GLOWING_TORCHFLOWERS;
    ...
    static {
        ...
        RAINBOW_ANTS_LEAD_TO_INFINITY_DIMENSIONS = b
                ...
                .define("rainbowAntsLeadToInfinityDimensions", net.minecraftforge.fml.ModList.get().isLoaded("infinity"));
        b.pop();
