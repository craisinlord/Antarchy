...
public final class JumpyBootsNetworking {
    ...
    public static void register() {
        AntarchyForgeNetworkCore.registerC2S(JumpyBootsLaunchPayload.class, JumpyBootsLaunchPayload.STREAM_CODEC, JumpyBootsNetworking::handleLaunch);
    }

    private static void handleLaunch(ServerPlayer player, JumpyBootsLaunchPayload payload) {
        {
