...
public final class InvertedGeyserEruptionParticle extends NoRenderParticle {
    ...
    protected InvertedGeyserEruptionParticle(
        ...
        this.lifetime = 20;
        this.plumeParticle = new InvertedGeyserParticleOptions(AntarchyForgeMisc.INVERTED_GEYSER_PLUME.get(), this.fluidBlocks, options.direction());
        this.baseParticle = new InvertedGeyserBaseParticleOptions(AntarchyForgeMisc.INVERTED_GEYSER_BASE.get(), this.fluidBlocks, 1.5F, options.direction());
        this.poofParticle = new InvertedGeyserBaseParticleOptions(AntarchyForgeMisc.INVERTED_GEYSER_POOF.get(), this.fluidBlocks, 2.0F, options.direction());
    }
